...
class AbstractController extends \Devworx\AbstractController {
  ...
  public function getDomainDetails(): ?string {
    $what = null;
    if( $this->request->hasArgument('domain') ){
      switch($this->request->getArgument('domain')){
        case'full':{ $what = "*"; } break;
        case'system':{ $what = \Devworx\Repository::getSystemFields(true); }break;
        case'short':{ $what = "uid,customer,name"; }break;
      }
    }
    return $what;
  }
  
  public function getHostingDetails(): ?string {
    $what = null;
    if( $this->request->hasArgument('hosting') ){
      switch($this->request->getArgument('hosting')){
        case'full':{ $what = "*"; } break;
        case'system':{ $what = \Devworx\Repository::getSystemFields(true); }break;
        case'short':{ $what = "uid,customer,account"; }break;
      }
    }
    return $what;
  }
  ...
  public function getContractDetails(): ?string {
    $what = null;
    if( $this->request->hasArgument('contract') ){
      switch($this->request->getArgument('contract')){
        case'full':{ $what = "*"; } break;
        case'system':{ $what = \Devworx\Repository::getSystemFields(true); }break;
        case'short':{ $what = "uid,name,customer,invoice,startDate"; }break;
      }
    }
    return $what;
  }
  ...
  public function getServiceDetails(): ?string {
    ...
    if( $this->request->hasArgument('service') ){
      switch($this->request->getArgument('service')){
        case'full':{ $what = "*"; } break;
        case'system':{ $what = \Devworx\Repository::getSystemFields(true); }break;
        case'short':{ $what = "uid,name,article,amount"; }break;
      }
    }
    return $what;
  }
