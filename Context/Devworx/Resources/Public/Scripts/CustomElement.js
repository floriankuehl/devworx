...
export default function CustomElement(Base) {
  return class extends Base {
	...
	static createElement(callback=null){ return ElementUtility.instance(this,callback) }
	static register(){ return ElementUtility.registerClass(this)	}
	...
	html(...list){
		return ElementUtility.html(this,...list)
	}
