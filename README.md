...
<p>The solution can be controlled in the frontend and API context via controllers and actions.</p>
...
<p>Database entries in Devworx have a basic structure that allows for easy data handling.</p>
<ul>
